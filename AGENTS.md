...
- Canonical prompts: `./docs/audit_app.md`, `./docs/audit_server.md`, `./docs/audit_doc_vs_impl.md`
...
This repo holds only generic, paste-ready canonical audit *prompts* and temporary deprecated-path aliases — no product code or build. Route by target, then DB/profile and actual capabilities; do not route by tool/model name. Never commit secrets, credentials, or project/customer-specific information (see the "置かないもの" section in `CLAUDE.md`).
